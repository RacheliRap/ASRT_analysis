...
The pipeline operates as an integrated "round-trip" ecosystem across the three scripts:

Phase 1: Preprocessing & Coordination (scripts/1_preprocessing.Rmd)
...
Phase 2: Latent EM Classification (scripts/2_em_classification.ipynb)
...
Phase 3: Validation, Embeddings, and Browser Tracks (scripts/3_downstream_analysis.Rmd)
